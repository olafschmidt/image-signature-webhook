...
import (
	...
	grafeas "github.com/saint-j/grafeas-client-go-v1beta1"
...
func main() {
	...
	flag.StringVar(&grafeasUrl, "grafeas", "http://grafeas.ingress.ctoospo.ctoarch.shoot.canary.k8s-hana.ondemand.com", "The Grafeas server address")
